...
> Curated list of awesome [AWS Cloud Development Kit](https://github.com/awslabs/aws-cdk) ⭐ 12,885 | 🐛 2,868 | 🌐 TypeScript | 📅 2026-09-03 (AWS CDK) open-source projects, guides, blogs and other resources.
...
* [cdk-iam-floyd](https://github.com/udondan/iam-floyd) ⭐ 572 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-03 - IAM policy statement generator with fluent interface.
...
* [cdk-monitoring-constructs](https://github.com/cdklabs/cdk-monitoring-constructs) ⭐ 554 | 🐛 65 | 🌐 TypeScript | 📅 2026-09-03 - Use high-level APIs to create monitoring for your AWS apps. Generates dashboards automatically.
...
* [SST](https://github.com/serverless-stack/serverless-stack) ⭐ 26,282 | 🐛 318 | 🌐 TypeScript | 📅 2026-07-12 - An open source framework for building serverless applications with CDK. It features a Live Lambda Development environment, to test and debug Lambda functions locally without having to redeploy them.
...
* [aws-lambda-nodejs-esbuild](https://github.com/floydspace/aws-lambda-nodejs-esbuild) ⭐ 69 | 🐛 4 | 🌐 TypeScript | 📅 2021-07-19 - Alternative Node.js lambda CDK construct, using [esbuild](https://github.com/evanw/esbuild) ⭐ 40,037 | 🐛 618 | 🌐 Go | 📅 2026-08-09.
...
* [jsii-publish](https://github.com/udondan/jsii-publish) ⚠️ Archived - A [Docker image](https://hub.docker.com/r/udondan/jsii-publish) and [GitHub action](https://github.com/marketplace/actions/jsii-publish) to build and publish CDK constructs created via [JSII](https://github.com/aws/jsii) ⭐ 2,866 | 🐛 161 | 🌐 TypeScript | 📅 2026-09-03.
...
* [Create and Publish CDK Constructs Using projen and jsii](https://github.com/seeebiii/projen-test) ⭐ 38 | 🐛 7 | 🌐 TypeScript | 📅 2023-03-06 - A step-by-step guide with sample code to create a new CDK construct using [projen](https://github.com/projen/projen) ⭐ 2,954 | 🐛 239 | 🌐 TypeScript | 📅 2026-09-03 and `jsii` and publish it to npm, Maven Central, PyPi and NuGet.
...
* [cdk8s](https://github.com/awslabs/cdk8s/) ⭐ 4,854 | 🐛 74 | 🌐 JavaScript | 📅 2026-09-03 - Define Kubernetes native apps and abstractions using object-oriented programming.
* [jsii](https://github.com/awslabs/jsii) ⭐ 2,866 | 🐛 161 | 🌐 TypeScript | 📅 2026-09-03 - JavaScript interop interface, the technology that CDK uses to create language bindings (currently supports .NET, Java and Python).
