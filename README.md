...
> Curated list of awesome [AWS Cloud Development Kit](https://github.com/awslabs/aws-cdk) ⭐ 12,868 | 🐛 2,825 | 🌐 TypeScript | 📅 2026-08-14 (AWS CDK) open-source projects, guides, blogs and other resources.
...
* [cdk-iam-floyd](https://github.com/udondan/iam-floyd) ⭐ 573 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-14 - IAM policy statement generator with fluent interface.
...
* [SST](https://github.com/serverless-stack/serverless-stack) ⭐ 26,230 | 🐛 294 | 🌐 TypeScript | 📅 2026-07-12 - An open source framework for building serverless applications with CDK. It features a Live Lambda Development environment, to test and debug Lambda functions locally without having to redeploy them.
...
* [aws-lambda-nodejs-esbuild](https://github.com/floydspace/aws-lambda-nodejs-esbuild) ⭐ 69 | 🐛 3 | 🌐 TypeScript | 📅 2021-07-19 - Alternative Node.js lambda CDK construct, using [esbuild](https://github.com/evanw/esbuild) ⭐ 40,014 | 🐛 601 | 🌐 Go | 📅 2026-08-09.
...
* [Create and Publish CDK Constructs Using projen and jsii](https://github.com/seeebiii/projen-test) ⭐ 38 | 🐛 7 | 🌐 TypeScript | 📅 2023-03-06 - A step-by-step guide with sample code to create a new CDK construct using [projen](https://github.com/projen/projen) ⭐ 2,940 | 🐛 245 | 🌐 TypeScript | 📅 2026-08-14 and `jsii` and publish it to npm, Maven Central, PyPi and NuGet.
