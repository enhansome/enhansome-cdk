...
> Curated list of awesome [AWS Cloud Development Kit](https://github.com/awslabs/aws-cdk) ⭐ 12,876 | 🐛 2,858 | 🌐 TypeScript | 📅 2026-08-24 (AWS CDK) open-source projects, guides, blogs and other resources.
...
* [aws-lambda-nodejs-esbuild](https://github.com/floydspace/aws-lambda-nodejs-esbuild) ⭐ 69 | 🐛 3 | 🌐 TypeScript | 📅 2021-07-19 - Alternative Node.js lambda CDK construct, using [esbuild](https://github.com/evanw/esbuild) ⭐ 40,020 | 🐛 606 | 🌐 Go | 📅 2026-08-09.
...
* [Create and Publish CDK Constructs Using projen and jsii](https://github.com/seeebiii/projen-test) ⭐ 38 | 🐛 7 | 🌐 TypeScript | 📅 2023-03-06 - A step-by-step guide with sample code to create a new CDK construct using [projen](https://github.com/projen/projen) ⭐ 2,947 | 🐛 246 | 🌐 TypeScript | 📅 2026-08-24 and `jsii` and publish it to npm, Maven Central, PyPi and NuGet.
...
* [cdk8s](https://github.com/awslabs/cdk8s/) ⭐ 4,851 | 🐛 77 | 🌐 JavaScript | 📅 2026-08-24 - Define Kubernetes native apps and abstractions using object-oriented programming.
