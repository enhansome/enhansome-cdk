...
> Curated list of awesome [AWS Cloud Development Kit](https://github.com/awslabs/aws-cdk) ⭐ 12,907 | 🐛 2,872 | 🌐 TypeScript | 📅 2026-09-21 (AWS CDK) open-source projects, guides, blogs and other resources.
...
* [cdk-iam-floyd](https://github.com/udondan/iam-floyd) ⭐ 571 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-19 - IAM policy statement generator with fluent interface.
...
* [SST](https://github.com/serverless-stack/serverless-stack) ⭐ 26,311 | 🐛 336 | 🌐 TypeScript | 📅 2026-07-12 - An open source framework for building serverless applications with CDK. It features a Live Lambda Development environment, to test and debug Lambda functions locally without having to redeploy them.
...
* [jsii-publish](https://github.com/udondan/jsii-publish) ⚠️ Archived - A [Docker image](https://hub.docker.com/r/udondan/jsii-publish) and [GitHub action](https://github.com/marketplace/actions/jsii-publish) to build and publish CDK constructs created via [JSII](https://github.com/aws/jsii) ⭐ 2,867 | 🐛 162 | 🌐 TypeScript | 📅 2026-09-21.
...
* [Official CDK Examples](https://github.com/aws-samples/aws-cdk-examples) ⭐ 5,635 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-21 - A set of example projects for the AWS CDK.
...
* [Create and Publish CDK Constructs Using projen and jsii](https://github.com/seeebiii/projen-test) ⭐ 38 | 🐛 7 | 🌐 TypeScript | 📅 2023-03-06 - A step-by-step guide with sample code to create a new CDK construct using [projen](https://github.com/projen/projen) ⭐ 2,956 | 🐛 241 | 🌐 TypeScript | 📅 2026-09-21 and `jsii` and publish it to npm, Maven Central, PyPi and NuGet.
...
* [cdk8s](https://github.com/awslabs/cdk8s/) ⭐ 4,856 | 🐛 71 | 🌐 JavaScript | 📅 2026-09-21 - Define Kubernetes native apps and abstractions using object-oriented programming.
* [jsii](https://github.com/awslabs/jsii) ⭐ 2,867 | 🐛 162 | 🌐 TypeScript | 📅 2026-09-21 - JavaScript interop interface, the technology that CDK uses to create language bindings (currently supports .NET, Java and Python).
