...
> Curated list of awesome [AWS Cloud Development Kit](https://github.com/awslabs/aws-cdk) ⭐ 12,899 | 🐛 2,860 | 🌐 TypeScript | 📅 2026-09-17 (AWS CDK) open-source projects, guides, blogs and other resources.
...
* [cdk-dynamo-table-viewer](https://github.com/eladb/cdk-dynamo-table-viewer) ⭐ 125 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-14 - Exposes the contents of an Amazon DynamoDB table through a public HTML page.
...
* [cdk-postgresql](https://github.com/botpress/cdk-postgresql) ⭐ 25 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-11 - AWS CDK Constructs for PostgreSQL.
...
* [cdk-iam-floyd](https://github.com/udondan/iam-floyd) ⭐ 571 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-17 - IAM policy statement generator with fluent interface.
...
* [aws-delivlib](https://github.com/awslabs/aws-delivlib) ⭐ 377 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-14 - Synthesizes CI/CD pipelines for multi-language software delivery (used by the CDK itself).

### Monitoring

* [cdk-monitoring-constructs](https://github.com/cdklabs/cdk-monitoring-constructs) ⭐ 554 | 🐛 65 | 🌐 TypeScript | 📅 2026-09-17 - Use high-level APIs to create monitoring for your AWS apps. Generates dashboards automatically.
* [cdk-watchful](https://github.com/eladb/cdk-watchful) ⭐ 541 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-14 - Automatic dashboards and alarms for CDK apps.
...
* [cdk-organizations](https://github.com/pepperize/cdk-organizations) ⭐ 183 | 🐛 26 | 🌐 TypeScript | 📅 2026-02-19 - CDK constructs that helps to provision AWS Organization, Organizational Units (OU), Accounts and Policies.
...
* [SST](https://github.com/serverless-stack/serverless-stack) ⭐ 26,301 | 🐛 324 | 🌐 TypeScript | 📅 2026-07-12 - An open source framework for building serverless applications with CDK. It features a Live Lambda Development environment, to test and debug Lambda functions locally without having to redeploy them.
...
* [aws-lambda-nodejs-esbuild](https://github.com/floydspace/aws-lambda-nodejs-esbuild) ⭐ 69 | 🐛 4 | 🌐 TypeScript | 📅 2021-07-19 - Alternative Node.js lambda CDK construct, using [esbuild](https://github.com/evanw/esbuild) ⭐ 40,059 | 🐛 622 | 🌐 Go | 📅 2026-08-09.
...
* [jsii-publish](https://github.com/udondan/jsii-publish) ⚠️ Archived - A [Docker image](https://hub.docker.com/r/udondan/jsii-publish) and [GitHub action](https://github.com/marketplace/actions/jsii-publish) to build and publish CDK constructs created via [JSII](https://github.com/aws/jsii) ⭐ 2,868 | 🐛 163 | 🌐 TypeScript | 📅 2026-09-16.
* [GitHub Action](https://github.com/marketplace/actions/aws-cdk-action) - GitHub Action for AWS CDK.

## Tools

* [CDK-Dia](https://github.com/pistazie/cdk-dia) ⭐ 969 | 🐛 35 | 🌐 JavaScript | 📅 2026-05-09 - Automatic infrastructure diagrams for AWS CDK.

## Training Materials and Sample Code

* [Official CDK Examples](https://github.com/aws-samples/aws-cdk-examples) ⭐ 5,633 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-08 - A set of example projects for the AWS CDK.
...
* [Create and Publish CDK Constructs Using projen and jsii](https://github.com/seeebiii/projen-test) ⭐ 38 | 🐛 7 | 🌐 TypeScript | 📅 2023-03-06 - A step-by-step guide with sample code to create a new CDK construct using [projen](https://github.com/projen/projen) ⭐ 2,955 | 🐛 244 | 🌐 TypeScript | 📅 2026-09-17 and `jsii` and publish it to npm, Maven Central, PyPi and NuGet.
...
* [cdk8s](https://github.com/awslabs/cdk8s/) ⭐ 4,854 | 🐛 70 | 🌐 JavaScript | 📅 2026-09-17 - Define Kubernetes native apps and abstractions using object-oriented programming.
* [jsii](https://github.com/awslabs/jsii) ⭐ 2,868 | 🐛 163 | 🌐 TypeScript | 📅 2026-09-16 - JavaScript interop interface, the technology that CDK uses to create language bindings (currently supports .NET, Java and Python).
...
* [Testing Your Construct Library CodeBuild Configuration Locally](https://github.com/aws/aws-codebuild-docker-images/tree/master/local_builds) ⭐ 1,165 | 🐛 80 | 🌐 Dockerfile | 📅 2026-09-10 - With the `jsii/superchain:latest` Docker Image.
