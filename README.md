...
* [SST](https://github.com/serverless-stack/serverless-stack) ⭐ 26,294 | 🐛 322 | 🌐 TypeScript | 📅 2026-07-12 - An open source framework for building serverless applications with CDK. It features a Live Lambda Development environment, to test and debug Lambda functions locally without having to redeploy them.
...
* [Official CDK Examples](https://github.com/aws-samples/aws-cdk-examples) ⭐ 5,632 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-08 - A set of example projects for the AWS CDK.
