...
> Curated list of awesome [AWS Cloud Development Kit](https://github.com/awslabs/aws-cdk) ⭐ 12,910 | 🐛 2,873 | 🌐 TypeScript | 📅 2026-09-22 (AWS CDK) open-source projects, guides, blogs and other resources.
...
* [cdk-dynamo-table-viewer](https://github.com/eladb/cdk-dynamo-table-viewer) ⭐ 125 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-21 - Exposes the contents of an Amazon DynamoDB table through a public HTML page.
...
* [cdk-iam-floyd](https://github.com/udondan/iam-floyd) ⭐ 571 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-22 - IAM policy statement generator with fluent interface.
...
* [aws-delivlib](https://github.com/awslabs/aws-delivlib) ⭐ 377 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-21 - Synthesizes CI/CD pipelines for multi-language software delivery (used by the CDK itself).

### Monitoring

* [cdk-monitoring-constructs](https://github.com/cdklabs/cdk-monitoring-constructs) ⭐ 554 | 🐛 65 | 🌐 TypeScript | 📅 2026-09-21 - Use high-level APIs to create monitoring for your AWS apps. Generates dashboards automatically.
* [cdk-watchful](https://github.com/eladb/cdk-watchful) ⭐ 541 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-21 - Automatic dashboards and alarms for CDK apps.
...
* [SST](https://github.com/serverless-stack/serverless-stack) ⭐ 26,314 | 🐛 339 | 🌐 TypeScript | 📅 2026-07-12 - An open source framework for building serverless applications with CDK. It features a Live Lambda Development environment, to test and debug Lambda functions locally without having to redeploy them.
...
* [aws-lambda-nodejs-esbuild](https://github.com/floydspace/aws-lambda-nodejs-esbuild) ⭐ 69 | 🐛 4 | 🌐 TypeScript | 📅 2021-07-19 - Alternative Node.js lambda CDK construct, using [esbuild](https://github.com/evanw/esbuild) ⭐ 40,068 | 🐛 622 | 🌐 Go | 📅 2026-08-09.
...
* [jsii-publish](https://github.com/udondan/jsii-publish) ⚠️ Archived - A [Docker image](https://hub.docker.com/r/udondan/jsii-publish) and [GitHub action](https://github.com/marketplace/actions/jsii-publish) to build and publish CDK constructs created via [JSII](https://github.com/aws/jsii) ⭐ 2,868 | 🐛 157 | 🌐 TypeScript | 📅 2026-09-22.
...
* [Official CDK Examples](https://github.com/aws-samples/aws-cdk-examples) ⭐ 5,635 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-22 - A set of example projects for the AWS CDK.
...
* [Create and Publish CDK Constructs Using projen and jsii](https://github.com/seeebiii/projen-test) ⭐ 38 | 🐛 7 | 🌐 TypeScript | 📅 2023-03-06 - A step-by-step guide with sample code to create a new CDK construct using [projen](https://github.com/projen/projen) ⭐ 2,957 | 🐛 240 | 🌐 TypeScript | 📅 2026-09-22 and `jsii` and publish it to npm, Maven Central, PyPi and NuGet.
...
* [cdk8s](https://github.com/awslabs/cdk8s/) ⭐ 4,856 | 🐛 71 | 🌐 JavaScript | 📅 2026-09-22 - Define Kubernetes native apps and abstractions using object-oriented programming.
* [jsii](https://github.com/awslabs/jsii) ⭐ 2,868 | 🐛 157 | 🌐 TypeScript | 📅 2026-09-22 - JavaScript interop interface, the technology that CDK uses to create language bindings (currently supports .NET, Java and Python).
