...
> Curated list of awesome [AWS Cloud Development Kit](https://github.com/awslabs/aws-cdk) ⭐ 12,872 | 🐛 2,839 | 🌐 TypeScript | 📅 2026-08-20 (AWS CDK) open-source projects, guides, blogs and other resources.
...
* [cdk-chalice](https://github.com/alexpulver/cdk-chalice) ⭐ 43 | 🐛 0 | 🌐 Python | 📅 2023-12-23 - AWS CDK construct for AWS Chalice (Python Serverless Microframework for AWS).
* [auto-cdk](https://github.com/wulfmann/auto-cdk) ⭐ 24 | 🐛 42 | 🌐 TypeScript | 📅 2023-01-07 - Automatically generate api-gateway/lambda integrations with the filesystem (beta).
* [crow-api](https://github.com/thomasstep/crow-api) ⭐ 10 | 🐛 0 | 🌐 TypeScript | 📅 2022-03-29 - Create a serverless API with routes based on your file structure.

### Databases

* [cdk-dynamo-table-viewer](https://github.com/eladb/cdk-dynamo-table-viewer) ⭐ 125 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-17 - Exposes the contents of an Amazon DynamoDB table through a public HTML page.
* [aws-cdk-dynamodb-seeder](https://github.com/elegantdevelopment/aws-cdk-dynamodb-seeder) ⭐ 38 | 🐛 18 | 🌐 TypeScript | 📅 2023-01-06 - A simple CDK seeder for DynamoDB.
* [cdk-postgresql](https://github.com/botpress/cdk-postgresql) ⭐ 25 | 🐛 6 | 🌐 TypeScript | 📅 2026-02-16 - AWS CDK Constructs for PostgreSQL.
* [cdk-sqlserver-seeder](https://github.com/kolomied/cdk-sqlserver-seeder) ⭐ 8 | 🐛 18 | 🌐 PowerShell | 📅 2023-01-06 - CDK construct that executes custom SQL scripts against SQL Server database.
...
* [cdk-static-website](https://github.com/cloudcomponents/cdk-components/blob/master/packages/cdk-static-website) ⭐ 635 | 🐛 55 | 🌐 TypeScript | 📅 2024-09-15 - CDK component that creates a static website using S3, configures CloudFront (CDN) and maps a custom domain via Route53 (DNS).
* [ness](https://github.com/nessjs/ness) ⭐ 633 | 🐛 11 | 🌐 TypeScript | 📅 2022-10-14 - CDK powered CLI tool for deploying static sites to your AWS account.
...
* [cdk-iam-floyd](https://github.com/udondan/iam-floyd) ⭐ 573 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-20 - IAM policy statement generator with fluent interface.
...
* [cdk-iam-generator](https://github.com/srihariph/cdk-iam-generator) ⭐ 19 | 🐛 9 | 🌐 TypeScript | 📅 2022-03-26 - Construct to generate IAM Managed Policies and IAM Roles using JSON Configuration.
* [k9-cdk](https://github.com/k9securityio/k9-cdk) ⭐ 8 | 🐛 2 | 🌐 TypeScript | 📅 2026-04-15 - Construct to generate secure S3 bucket policies easily.

### Ops

* [cdk-time-bomb](https://github.com/jmb12686/cdk-time-bomb) ⭐ 41 | 🐛 22 | 🌐 TypeScript | 📅 2026-03-07 - CDK Construct that implodes your AWS CDK Stack after a set amount of time.
* [cdk-instanceStopRule](https://github.com/tecracer/cdk-constructs/tree/master/packages/cdk-instanceStopRule) ⭐ 0 | 🐛 11 | 🌐 TypeScript | 📅 2023-01-05 - CDK component which creates an instance with a CloudWatch rule to stop it at the end of the day.

### Queue

* [cdk-sqs-monitored](https://github.com/kamilbiela/cdk-sqs-monitored) ⭐ 20 | 🐛 4 | 🌐 TypeScript | 📅 2026-04-09 - SQS Construct with dead letter queue and configured alarms.
* [cdk-ses-template-mailer](https://github.com/mkrn/cdk-ses-template-mailer) ⭐ 15 | 🐛 12 | 🌐 TypeScript | 📅 2023-01-04 - Constructs to create AWS SES email templates + microservice to send templated emails with AWS SES.
...
* [aws-delivlib](https://github.com/awslabs/aws-delivlib) ⭐ 376 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-17 - Synthesizes CI/CD pipelines for multi-language software delivery (used by the CDK itself).

### Monitoring

* [cdk-monitoring-constructs](https://github.com/cdklabs/cdk-monitoring-constructs) ⭐ 552 | 🐛 67 | 🌐 TypeScript | 📅 2026-08-17 - Use high-level APIs to create monitoring for your AWS apps. Generates dashboards automatically.
* [cdk-watchful](https://github.com/eladb/cdk-watchful) ⭐ 541 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-17 - Automatic dashboards and alarms for CDK apps.
...
* [cdk-pull-request-check](https://github.com/cloudcomponents/cdk-components/blob/master/packages/cdk-pull-request-check) ⭐ 635 | 🐛 55 | 🌐 TypeScript | 📅 2024-09-15 - CDK component that automatically check pull requests.
* [cdk-github-webhook](https://github.com/cloudcomponents/cdk-components/blob/master/packages/cdk-github-webhook) ⭐ 635 | 🐛 55 | 🌐 TypeScript | 📅 2024-09-15 - CDK component that provisions GitHub webhooks.
* [cdk-codepipeline-slack](https://github.com/cloudcomponents/cdk-components/blob/master/packages/cdk-codepipeline-slack) ⭐ 635 | 🐛 55 | 🌐 TypeScript | 📅 2024-09-15 - CDK component that provisions a #slack approval workflow.
...
* [aws-pdf-textract-pipeline](https://github.com/aeksco/aws-pdf-textract-pipeline) ⭐ 165 | 🐛 5 | 🌐 TypeScript | 📅 2024-06-05 - ETL pipeline for crawling PDFs from the Web using Puppeteer and transforming their contents into structured data using AWS Textract and storing the results in DynamoDB.
...
* [cdk-organizations](https://github.com/pepperize/cdk-organizations) ⭐ 182 | 🐛 26 | 🌐 TypeScript | 📅 2026-02-19 - CDK constructs that helps to provision AWS Organization, Organizational Units (OU), Accounts and Policies.
* [aws-bootstrap-kit](https://github.com/awslabs/aws-bootstrap-kit) ⚠️ Archived - Creates a multi-account set-up with AWS Organization, AWS SSO, DNS, and AWS CodePipeline.

## High-Level Frameworks

* [SST](https://github.com/serverless-stack/serverless-stack) ⭐ 26,243 | 🐛 300 | 🌐 TypeScript | 📅 2026-07-12 - An open source framework for building serverless applications with CDK. It features a Live Lambda Development environment, to test and debug Lambda functions locally without having to redeploy them.
* [punchcard](https://github.com/punchcard/punchcard) ⭐ 516 | 🐛 41 | 🌐 TypeScript | 📅 2021-12-09 - TypeScript framework to unify infrastructure and runtime code for the CDK, so you can declare constructs and implement runtime logic within the context of one Node.js application.
...
* [cdk-stepfunctions-patterns](https://github.com/kolomied/cdk-stepfunctions-patterns) ⭐ 68 | 🐛 0 | 🌐 TypeScript | 📅 2020-12-15 - A set of Step Functions high-level resiliency patterns.
* [Orkestra](https://github.com/knowsuchagency/orkestra) ⭐ 51 | 🐛 1 | 🌐 Python | 📅 2024-02-05 - An event-driven alternative to Airflow built on the AWS CDK and Step Functions.

## Scaffolding

* [ReactJS + Cognito + CDK Starter](https://github.com/vbudilov/reactjs-cognito-starter) ⭐ 189 | 🐛 4 | 🌐 JavaScript | 📅 2025-02-20 - Starter project for ReactJS + Amazon Cognito + Amazon Amplify Framework with AWS CDK support.
* [create-cdk-app](https://github.com/cdk-tools/create-cdk-app) ⭐ 20 | 🐛 12 | 🌐 TypeScript | 📅 2022-06-22 - Create CDK apps from templates.
* [cra-template-aws-cdk](https://github.com/luisfarzati/rnbw-aws-cdk/tree/master/packages/cra-template-aws-cdk) ⭐ 16 | 🐛 10 | 🌐 JavaScript | 📅 2023-01-05 - Create React App template using AWS CDK for out of the box, simple provisioning of serverless React apps.
* [awscdk-jsii-template](https://github.com/pahud/awscdk-jsii-template) ⚠️ Archived - A GitHub template repository to generate a ready environment to build, test and publish your [JSII](\(https://github.com/aws/jsii\)) construct lib for AWS CDK.

## Language Support

* [aws-lambda-nodejs-esbuild](https://github.com/floydspace/aws-lambda-nodejs-esbuild) ⭐ 69 | 🐛 3 | 🌐 TypeScript | 📅 2021-07-19 - Alternative Node.js lambda CDK construct, using [esbuild](https://github.com/evanw/esbuild) ⭐ 40,008 | 🐛 603 | 🌐 Go | 📅 2026-08-09.
...
* [jsii-publish](https://github.com/udondan/jsii-publish) ⚠️ Archived - A [Docker image](https://hub.docker.com/r/udondan/jsii-publish) and [GitHub action](https://github.com/marketplace/actions/jsii-publish) to build and publish CDK constructs created via [JSII](https://github.com/aws/jsii) ⭐ 2,867 | 🐛 158 | 🌐 TypeScript | 📅 2026-08-20.
* [GitHub Action](https://github.com/marketplace/actions/aws-cdk-action) - GitHub Action for AWS CDK.

## Tools

* [CDK-Dia](https://github.com/pistazie/cdk-dia) ⭐ 973 | 🐛 35 | 🌐 JavaScript | 📅 2026-05-09 - Automatic infrastructure diagrams for AWS CDK.

## Training Materials and Sample Code

* [Official CDK Examples](https://github.com/aws-samples/aws-cdk-examples) ⭐ 5,616 | 🐛 13 | 🌐 TypeScript | 📅 2026-07-29 - A set of example projects for the AWS CDK.
* [CDK Patterns](https://github.com/cdk-patterns/serverless) ⭐ 2,352 | 🐛 116 | 🌐 TypeScript | 📅 2024-01-30 - An opensource collection of serverless architecture patterns built with CDK.
...
* [Create and Publish CDK Constructs Using projen and jsii](https://github.com/seeebiii/projen-test) ⭐ 38 | 🐛 7 | 🌐 TypeScript | 📅 2023-03-06 - A step-by-step guide with sample code to create a new CDK construct using [projen](https://github.com/projen/projen) ⭐ 2,943 | 🐛 249 | 🌐 TypeScript | 📅 2026-08-20 and `jsii` and publish it to npm, Maven Central, PyPi and NuGet.
...
* [GitHub repository](https://github.com/jakejscott/aws-cdk-phone-verify-api) ⭐ 7 | 🐛 10 | 🌐 C# | 📅 2022-12-09 - By Jake Scott.
* [GitHub Repo](https://github.com/HatchSoftware/automatic-aws-db-shutdown-cdk) ⭐ 5 | 🐛 15 | 🌐 TypeScript | 📅 2023-01-05 - By Maarten Thoelen.
* [GitHub Repo](https://github.com/ClouderDex/CDK-UDP-NLB-Demo) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2019-07-12 - By ClouderDex.
...
* [cdk8s](https://github.com/awslabs/cdk8s/) ⭐ 4,851 | 🐛 78 | 🌐 JavaScript | 📅 2026-08-20 - Define Kubernetes native apps and abstractions using object-oriented programming.
* [jsii](https://github.com/awslabs/jsii) ⭐ 2,867 | 🐛 158 | 🌐 TypeScript | 📅 2026-08-20 - JavaScript interop interface, the technology that CDK uses to create language bindings (currently supports .NET, Java and Python).
...
* [Testing Your Construct Library CodeBuild Configuration Locally](https://github.com/aws/aws-codebuild-docker-images/tree/master/local_builds) ⭐ 1,165 | 🐛 80 | 🌐 Dockerfile | 📅 2026-07-29 - With the `jsii/superchain:latest` Docker Image.
